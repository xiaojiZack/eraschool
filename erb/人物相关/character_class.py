...
def new_character_dict():
    new_character = {'基本信息': {
        'CharacterId': 0, '名字': '主人公', '外表年龄': '青年', '种族': '', '性别': '男性', 
        ...
        '气力值': 0, '最大理智值': 0, '理智值': 0}, 
                     ...
                     '经验': {'C经验': 0, 'V经验': 0, 'B经验': 0, 'A经验': 0, '高潮经验': 0, '精液经验': 0, 
                                'V扩张经验':0,'A扩张经验':0,
                                '喷乳经验': 0, '射精经验': 0, '漏尿经验': 0, '排泄经验': 0, '自慰经验': 0, 
                                '百合经验': 0, '男同经验': 0, '露出经验': 0, '侍奉经验': 0, '爱情经验': 0, '口交经验': 0, 
                                '腔射经验': 0, '肛射经验': 0, '饮精经验': 0, '亲吻经验': 0, '苦痛经验': 0, '受缚经验': 0, 
                                'SM经验': 0, '药物经验': 0, 'V插入经验': 0, 'A插入经验': 0, '异常经验': 0, '出产经验': 0, 
                                '被摄经验': 0, '卖春经验': 0, '艳舞经验': 0, '触手经验': 0, '兽奸经验': 0, '助手经验': 0}, 
                     '记忆': {'快C记忆': 0, '快V记忆': 0, '快B记忆': 0, '快A记忆': 0, '习得记忆': 0, '恭顺记忆': 0, '欲情记忆': 0, '屈服记忆': 0, 
                                '羞耻记忆': 0, '苦痛记忆': 0, '恐惧记忆': 0, '药毒记忆': 0, '同化记忆': 0, '主导记忆': 0, '否定记忆': 0}, 
                     '开发': {'C感觉': 0, 'V感觉': 0, 'B感觉': 0, 'A感觉': 0, '服从': 0, '欲望': 0, '侍奉欲望': 0, 
                                  '暴露癖': 0, 'S属性': 0, 'M属性': 0, '百合中毒': 0, '男同中毒': 0, '喷乳中毒': 0, '射精中毒': 0, 
                                  '精液成瘾': 0, '自慰成瘾': 0, '药物成瘾': 0, '被射成瘾': 0, 
                                  '排泄成瘾': 0, '触手适性': 0, '兽交成瘾': 0, '受孕成瘾': 0}, 
