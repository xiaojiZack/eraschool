...
def new_character_dict():
    ...
    new_character = {
        'CharacterId': str(t+1), '名字': '主人公', '外表年龄': '青年', '种族': '人类', '性别': '男性', 
        'kojo': 'kojosample', '最大体力值': 0, '体力值': 0, '最大气力值': 0, 
        '气力值': 0, '最大理智值': 0, '理智值': 0, '好感度':0,'侍奉快乐':0,'催眠':0,'工作状态':'空闲',
                '身体信息': {
                        '三围': {},'具体身高':0, '具体体重':0,
                        '血液': {'容量': 5000,'内容总量':0, '内容液体': {}},
                        '肛门': {'改造': [], '内容固体': {}, '尺寸': ''}, 
                        '肠道': {'容量': 0,'内容总量':0, '内容液体': {}, '改造': []}, 
                        '胃': {'容量': 0,'内容总量':0, '内容液体': {}, '改造': []},
                        '尿道': {'容量': 0,'内容总量':0, '内容液体': {}, '内容固体': {}, '改造': [], '尺寸': ''}, 
                        '口喉': {'改造': [],'内容固体': {}}, 
                        '子宫': {'容量': 0,'内容总量':0, '内容液体': {}, '内容固体': {}, '危险日': 0, '怀孕标志': False, '改造': [], '胎儿信息': {}}, 
                        '阴道': {'内容固体': {}, '改造': [], '尺寸': ''}, 
                        '阴核': {'改造': []}, 
                        '乳房': {'容量': 0, '内容总量':0,'内容液体': {}, '生产速度': 0, '改造': [], '尺寸': '', '标准射出量': 0,'积攒计数器':0}, 
                        '阴茎': {'尺寸':'','容量': 0,'内容总量':0, '内容液体': {}, '生产速度': 0, '改造': [], '长度': 0, '直径': 0, '标准射出量': 0,'忍耐极限':10000,'积攒计数器':0,'插入位置':{}}}, 
                '经验': {'C经验': 0, 'V经验': 0, 'B经验': 0, 'A经验': 0, 'M经验':0, 'U经验':0, 'W经验':0, '绝顶经验': 0, '精液经验': 0,
                        'V扩张经验':0,'A扩张经验':0,'U扩张经验':0, '子宫经验':0, 'V性交经验':0, 'A性交经验':0,
                        '喷乳经验': 0, '射精经验': 0, '漏尿经验': 0, '排泄经验': 0, '自慰经验': 0, 
                        '百合经验': 0, '男同经验': 0, '露出经验': 0, '侍奉经验': 0, '爱情经验': 0, '口交经验': 0, 
                        '乳交经验':0, '深喉经验':0,
                        '腔射经验': 0, '肛射经验': 0, '腔内储精经验':0, '肠内储精经验':0,'子宫储精经验':0,'子宫灌注经验':0,
                        '饮精经验': 0, '亲吻经验': 0,  '受缚经验': 0, 
                        '施虐快乐经验': 0, '灌肠经验':0, '温泉灌肠经验':0,'被虐快乐经验': 0,
                        '尿道被射经验':0,'乳内被射经验':0,'轮奸经验':0,
                        '药物经验': 0, 'V插入经验': 0, 'A插入经验': 0, '异常经验': 0, '子宫姦经验':0,  '受孕经验': 0, 
                        '被摄经验': 0, '卖春经验': 0, '艳舞经验': 0, '触手经验': 0, '兽奸经验': 0, '助手经验': 0,
                        '腰技经验':0,'舌技经验':0,'指技经验':0,'魔乳经验':0,'足技经验':0,
                        '淫物鉴赏课程经验':0,
                        }, 
                '记忆': {'快C记忆': 0, '快V记忆': 0, '快B记忆': 0, '快A记忆': 0, '快M记忆':0, '快U记忆':0, '快W记忆':0,
                        '习得记忆': 0, '恭顺记忆': 0, '欲情记忆': 0, '屈服记忆': 0, 
                        '羞耻记忆': 0, '苦痛记忆': 0, '恐惧记忆': 0, '药毒记忆': 0, '同化记忆': 0, '主导记忆': 0, '反感记忆': 0}, 
                '开发': {'C感觉': 0, 'V感觉': 0, 'B感觉': 0, 'A感觉': 0, 'M感觉':0, 'U感觉':0,'W感觉':0,
                        '服从': 0, '欲望': 0, '侍奉欲望': 0, 
                        'V名器度':0, 'A名器度':0,'喉名器度':0,'V扩张度':3,'A扩张度':1,#'喉扩张度':0,
                        '尿道名器度':0,'尿道扩张度':0,'指技':0,'舌技':0,'腰技':0,'足技':0,'魔乳':0,
                ...
                '学籍': {'班级': '', '成绩': {}, '社团': ''}, 
                '属性': {'个性': [], '体质': [], '技能': [], '性癖': [], '其他': []},
                '调教记忆':{'快C':0, '快V':0, '快B':0, '快A':0, '快M':0, '快U':0, '快W':0,
                        'V润':0,'A润':0,'习得':0, '恭顺':0, '欲情':0, '屈服':0, 
                        '羞耻':0, '苦痛':0, '恐惧':0, '药毒':0, '同化':0, '主导':0, '反感':0},
                        '其他参数':{'性欲':0,'精液欲':0,'尿意':0,'排泄欲':0,'本次绝顶次数':0,'本次精液次数':0,'射精数值':0},
                        '待处理记忆':{'快C':0, '快V':0, '快B':0, '快A':0, '快M':0, '快U':0, '快W':0,
                        'V润':0,'A润':0,'习得':0, '恭顺':0, '欲情':0, '屈服':0, 
                        '羞耻':0, '苦痛':0, '恐惧':0, '药毒':0, '同化':0, '主导':0, '反感':0,
                        '好感度':0, '侍奉快乐':0,
                        '高潮快C':0, '高潮快V':0, '高潮快B':0, '高潮快A':0, '高潮快M':0, '高潮快U':0, '高潮快W':0,
                        '饮精成瘾指数':0,'腔出成瘾指数':0,'肛出成瘾指数':0},
                '待处理经验':{'C经验': 0, 'V经验': 0, 'B经验': 0, 'A经验': 0,'M经验':0, 'U经验':0, 'W经验':0, '绝顶经验': 0, '精液经验': 0, 
                        'V扩张经验':0,'A扩张经验':0,'U扩张经验':0, '子宫经验':0, 'V性交经验':0, 'A性交经验':0,
                        '喷乳经验': 0, '射精经验': 0, '漏尿经验': 0, '排泄经验': 0, '自慰经验': 0, 
                        '百合经验': 0, '男同经验': 0, '露出经验': 0, '侍奉经验': 0, '爱情经验': 0, '口交经验': 0, 
                        '乳交经验':0, '深喉经验':0,
                        '腔射经验': 0, '肛射经验': 0, '腔内储精经验':0, '精液灌肠经验':0,'子宫储精经验':0,'子宫灌注经验':0,
                        '饮精经验': 0, '亲吻经验': 0, '受缚经验': 0, 
                        '施虐快乐经验': 0, '灌肠经验':0, '温泉灌肠经验':0, '被虐快乐经验': 0,
                        '尿道被射经验':0,'乳内被射经验':0,'轮奸经验':0,
                        '药物经验': 0, 'V插入经验': 0, 'A插入经验': 0, '异常经验': 0,'子宫姦经验':0, '受孕经验': 0, 
                        '被摄经验': 0, '卖春经验': 0, '艳舞经验': 0, '触手经验': 0, '兽奸经验': 0, '助手经验': 0,
                        '指技经验': 0, '舌技经验': 0, '腰技经验': 0, '足技经验': 0, '魔乳经验':0,
                        }, 
                '待处理体力变化':[0,0,0],
                '衣物':{},
                '衣物效果':{
                ...
                '设定衣物':{},
                '标志':{'助手':False,'手占用':0,'口占用':0,'胸占用':0,'阴茎占用':0,'受缚类型':0,'口枷':False},
                '调教状态':[],
                '药物效果':{},
                '其他数值':{
                        '欲求不满':0,
