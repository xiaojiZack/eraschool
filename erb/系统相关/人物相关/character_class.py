    ...
    new_character = {
        ...
        '气力值': 0, '最大理智值': 0, '理智值': 0, '好感度':0,'侍奉快乐':0,
                ...
                '经验': {'C经验': 0, 'V经验': 0, 'B经验': 0, 'A经验': 0, '绝顶经验': 0, '精液经验': 0, 
                        ...
                        '腔射经验': 0, '肛射经验': 0, '腔内储精经验':0, '肠内储精经验':0,'子宫储精经验':0,'子宫被射经验':0,
                        '尿道被射经验':0,'乳内被射经验':0,
                        '饮精经验': 0, '亲吻经验': 0, '苦痛经验': 0, '受缚经验': 0, 'V扩张经验': 0, 'A扩张经验': 0,
                        'SM经验': 0, '药物经验': 0, 'V插入经验': 0, 'A插入经验': 0, '异常经验': 0, '受孕经验': 0, 
                ...
                '待处理经验':{'C经验': 0, 'V经验': 0, 'B经验': 0, 'A经验': 0,'M经验':0, 'U经验':0, 'W经验':0, '绝顶经验': 0, '精液经验': 0, 
                        'V扩张经验':0,'A扩张经验':0,'U扩张经验':0,
                        '喷乳经验': 0, '射精经验': 0, '漏尿经验': 0, '排泄经验': 0, '自慰经验': 0, 
                        '百合经验': 0, '男同经验': 0, '露出经验': 0, '侍奉经验': 0, '爱情经验': 0, '口交经验': 0, 
                        '乳交经验':0, '深喉经验':0,
                        '腔射经验': 0, '肛射经验': 0, '腔内储精经验':0, '精液灌肠经验':0,'子宫储精经验':0,
                        '饮精经验': 0, '亲吻经验': 0, '被虐快乐经验': 0, '受缚经验': 0, 
                        '施虐快乐经验': 0, '灌肠经验':0, '温泉灌肠经验':0,
                        '药物经验': 0, 'V插入经验': 0, 'A插入经验': 0, '子宫插入经验':0, '异常经验': 0, '受孕经验': 0, 
                        '被拍经验': 0, '卖春经验': 0, '艳舞经验': 0, '触手经验': 0, '兽奸经验': 0, '助手经验': 0,
