...
def com66(active,passive):
    ...
    if check_doing_list(active,passive,66):
        pm['羞耻'] += 450 * (1+passive['开发']['舌技']*1)
        pm['屈服'] += 600 * (1+passive['开发']['舌技']*1)
        pm['欲情'] += 300 * (1+passive['开发']['舌技']*1)
        pm['主导'] += 350 * (1+passive['开发']['舌技']*1)
        pm['习得'] += 300 * (1+passive['开发']['舌技']*1)
        pm['恐惧'] += 50 * (1-passive['开发']['舌技']*0.1)
        pm['快M'] += 30
        am['快C'] += 800 * (1+passive['开发']['舌技']*1)*(1+passive['开发']['喉名器度'])
        am['习得'] += 5
        pm['反感'] += 20
        pe['口交经验'] += 1
        pe['舌技经验'] += 1
