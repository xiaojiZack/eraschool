...
def com70(active,passive):
    ...
    if check_doing_list(active,passive,70):
        am['快C'] += 40 * (1+passive['开发']['腰技']*1)
        pm['羞耻'] += 450 * (1+passive['开发']['腰技']*1)
        pm['屈服'] += 600 * (1+passive['开发']['腰技']*1)
        pm['主导'] += 400 * (1+passive['开发']['腰技']*1)
        pm['欲情'] += 200 * (1+passive['开发']['腰技']*1)
        pm['恐惧'] += 100 * (1+passive['开发']['腰技']*1)
        pm['习得'] += 150 * (1+passive['开发']['腰技']*1)
        pm['快C'] += 50 * (1+passive['开发']['腰技']*1)
        am['习得'] += 50
        pm['反感'] += 40
        pe['腰技经验'] += 1
        pe['自慰经验'] += 1
