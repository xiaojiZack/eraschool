...
def com68(active,passive):
    ...
    if check_doing_list(active,passive,68):
        pm['羞耻'] += 400 * (1+passive['开发']['魔乳']*1+passive['开发']['舌技'])*0.75
        pm['屈服'] += 800 * (1+passive['开发']['魔乳']*1+passive['开发']['舌技'])*0.75
        pm['主导'] += 600 * (1+passive['开发']['魔乳']*1+passive['开发']['舌技'])*0.75
        pm['习得'] += 400 * (1+passive['开发']['魔乳']*1+passive['开发']['舌技'])*0.75
        pm['恭顺'] += 400 * (1+passive['开发']['魔乳']*1+passive['开发']['舌技'])*0.75
        pm['恐惧'] += 50 * (1+passive['开发']['魔乳']*1+passive['开发']['舌技'])*0.75
        pm['快B'] += 25 * (1+passive['开发']['魔乳']*1+passive['开发']['舌技'])*0.75
        pm['快M'] += 25 * (1+passive['开发']['魔乳']*1+passive['开发']['舌技'])*0.75
        am['快C'] += 1500 * (1+passive['开发']['魔乳']*1+passive['开发']['舌技'])*0.75
        am['习得'] += 10
        pm['反感'] += 60
        pe['乳交经验'] += 1
        pe['魔乳经验'] += 1
